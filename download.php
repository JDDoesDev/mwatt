 ...
 */
$ssga = new ssga('UA-106576524-1','meanwhileattemple.com');
...
if(isset($_GET['url']))
{
	 ...
	 */
	if( (strstr($domain, 'meanwhileattemple.com') && strstr($domain, 'mp3')) || (strstr($domain, 'meanwhileattemple.com') && strstr($domain, 'm4a')))
	{
		$domain   = preg_replace('/https?:\/\/(www\.)?meanwhileattemple.com/', '', $domain);
